...
ActiveRecord::Schema.define(version: 20190307034555) do
  ...
  add_index "w2p_templates", ["company_id"], name: "index_w2p_templates_on_company_id", using: :btree
  add_index "w2p_templates", ["spot_contact_set_id"], name: "index_w2p_templates_on_spot_contact_set_id", using: :btree
  add_index "w2p_templates", ["template_id"], name: "index_w2p_templates_on_template_id", using: :btree
